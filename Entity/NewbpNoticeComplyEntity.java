...
@Entity
@Table (name = "tbl_newbpnoticetocomply")
public class NewbpNoticeComplyEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int newnoticecomply_id;
	...
	public NewbpNoticeComplyEntity(int newnoticecomply_id, int bspermit_no, String permittee, String business_name,
