...
@Entity
@Table (name = "tbl_renewalcorrectviolation")
public class RenewalbpNoticeCorrectViolationEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int renewncv_id;
	...
	public RenewalbpNoticeCorrectViolationEntity(int renewncv_id, int bspermit_no, String permittee,
	...
	//getters and setters
	public int getRenewncv_id() {
		return renewncv_id;
	}


	//public void setRenewncv_id(int renewncv_id) {
		//this.renewncv_id = renewncv_id;
	//}
